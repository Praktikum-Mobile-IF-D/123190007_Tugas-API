  ...
  Widget _buildRegisterButton() {
    return _commonSubmitButton(
      ...
      submitCallback: (value) {
        ...
        _processRegister(currentUsername, currentBirth, currentPassword1, currentPassword2);
      },
    );
  }

  void _processRegister(String username, String birth, String password1, String password2) async {
    ...
    if (_usernameController.text.isNotEmpty &&
      ...
      if (_password1Controller.text == _password2Controller.text){
        List<int> passwordBytes = utf8.encode(_password2Controller.text);
